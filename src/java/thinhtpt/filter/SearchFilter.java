...
public class SearchFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (txtMinPrice != null
                    && txtMaxPrice != null
                    && ValidationHelper.isValidNumber(txtMinPrice)
                    && ValidationHelper.isValidNumber(txtMaxPrice)) {
                int minPrice = Integer.parseInt(txtMinPrice);
                int maxPrice = Integer.parseInt(txtMaxPrice);
                if (minPrice <= maxPrice) {
                    isValid = true;
                } else {
                    request.setAttribute("ERROR_PRICE", "Please input valid range (min <= max)");
                    isValid = false;
                }
            }
            if (isValid) {
                ...
                request.setAttribute("ERROR_SEARCH", "Please input at least one to search");
