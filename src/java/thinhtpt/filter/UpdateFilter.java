...
public class UpdateFilter implements Filter {
    ...
    private final String UPDATE_ERROR = "updateError";

    private final Logger LOGGER = Logger.getLogger(UpdateFilter.class);
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("UpdateFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("UpdateFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (statusText == null || statusText.trim().length() == 0) {
                foundErr = true;
                errors.setStatusErr("Status must be selected one");
            }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("UpdateFilter(");
