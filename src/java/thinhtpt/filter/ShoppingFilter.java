...
public class ShoppingFilter implements Filter {
    ...
    private final Logger LOGGER = Logger.getLogger(ShoppingFilter.class);
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("ShoppingFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("ShoppingFilter:DoAfterProcessing");
        }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("ShoppingFilter(");
